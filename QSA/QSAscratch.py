...
#    datafile = pd.read_csv('{}.csv'.format(filename), usecols = ['t','x1','x2','u'])
#    print(datafile.head())
#    t = datafile['t']
#    x1 = datafile['x1']
#    x2 = datafile['x2']
...
#plt.legend()
#plt.show() code for offline data 
...
def compute_u(Ke, x, t):
    ...
    a = np.random.rand(q,1)/100                           # Amplitude (0-1)
...
#x_offline=np.concatenate((x1,x2))
#u_offline=u
#time_offline=t
M = 0.5  # cart mass
m = 0.2  # pendulum mass
